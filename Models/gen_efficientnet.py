...
from .constants import IMAGENET_DPN_MEAN, IMAGENET_DPN_STD,IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
class GenEfficientNet(nn.Module):
    ...
    def __init__(self, block_args, num_classes=1000, in_chans=3, stem_size=32, num_features=1280,
        ...
        self.global_pool = SelectAdaptivePool2d(pool_type=global_pool) # output: 1x1 'avg'
